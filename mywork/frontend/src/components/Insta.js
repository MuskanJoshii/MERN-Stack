...
const Insta = () => {
  return (
    ...
    <div className='container_1 '>
        ...
        <div >
        <input className=' fc ' type="text"  placeholder='Phone number, username, or email' />
        ...
        <div className="fb_sec">
          <div className="line-1 text-secondary"></div>
        ...
        <span className='forpass'> <a href="#">Forgot password?</a></span>
